...
echo 'SANITY_STUDIO_TOKEN="<replace-with-your-token>" #REQUIRED IF AND ONLY IF THE DATASET IS PRIVATE - MORE INFO: https://stackoverflow.com/a/78758073/14276268' >> .env
